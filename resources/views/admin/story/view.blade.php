          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
               <div class="row">
                   <div class="col-3">
                       <a href="{{route('story.create')}}" class="btn btn-primary">Add Stories</a>                     </div>
                        <div class="col-9">
              ...
              <div class="card-body">
				...
				@foreach($stories as $story)
                  <tr>
					  <td>{{$story->title}}</td>
                      <td><img src="{{$story->image}}" height="80px" width="80px"/></td>
                      <td>{{$story->short_description}}</td>
                      <td>
                        @if($story->isactive==1){{'Yes'}}
                             @else{{'No'}}
                             @endif
                      </td>
                      <td>
                          <a href="{{route('story.edit',['id'=>$story->id])}}" class="btn btn-success">Edit</a>
                      </td>
                 </tr>
                 @endforeach
                  </tbody>
