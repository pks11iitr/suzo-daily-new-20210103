                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Add Super Grocery</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" method="post" enctype="multipart/form-data" action="{{route('homesection.supergrocerystore')}}">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="type" >
                                                    <option value="product1">Products 1</option>
                                                    <option value="product2">Products 2</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
