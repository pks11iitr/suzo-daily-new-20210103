          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
				  <div class="row">
						 <div class="col-3">
                <a href="{{route('offer.create')}}" class="btn btn-primary">Add Category</a></div>
                          <div class="col-9">
        ...
        <form class="form-validate form-horizontal"  method="get" action="" enctype="multipart/form-data">
              ...
              <div class="card-body">
				...
				@foreach($offers as $offer)
                  <tr>
					  <td>{{$offer->name}}</td>
                      <td><img src="{{$offer->image}}" height="80px" width="80px"/></td>
                       <td>
                        @if($offer->isactive==1){{'Yes'}}
                             @else{{'No'}}
                             @endif
                        </td>
                      <td><a href="{{route('offer.edit',['id'=>$offer->id])}}" class="btn btn-success">Edit</a></td>
                 </tr>
                 @endforeach
                  </tbody>
                  <tfoot>
