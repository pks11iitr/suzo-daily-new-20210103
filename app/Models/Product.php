...
class Product extends Model
{
    ...
    protected $fillable=['name','description','company','ratings','image','isactive','stock_type','image','is_offer','min_qty','max_qty','stock','is_discounted','is_newarrival','is_hotdeal','price','cut_price', 'cgst', 'sgst', 'eligible_goldcash', 'can_be_subscribed', 'subscription_cashback', 'delivery_charge', 'unit'];
